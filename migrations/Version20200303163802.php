...
final class Version20200303163802 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE elected_representative_mandate (id INT AUTO_INCREMENT NOT NULL, elected_representative_id INT NOT NULL, type VARCHAR(255) NOT NULL, is_elected TINYINT(1) DEFAULT \'0\' NOT NULL, geographical_area VARCHAR(255) NOT NULL, begin_at DATE NOT NULL, finish_at DATETIME DEFAULT NULL, political_affiliation VARCHAR(10) DEFAULT NULL, la_remsupport VARCHAR(255) DEFAULT NULL, INDEX IDX_38609146D38DA5D3 (elected_representative_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
