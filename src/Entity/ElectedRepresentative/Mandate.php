...
class Mandate
{
     ...
     *
     * @Assert\DateTime
     * @Assert\Expression("value > this.getBeginAt()", message="elected_representative.mandate.invalid_date_range")
     */
    private $finishAt;
    ...
    public function setPoliticalAffiliation(?string $politicalAffiliation = null): void
    {
        $this->politicalAffiliation = $politicalAffiliation;
    }
